...
public class RegisterUser {
    ...
    public void registerUser() throws InterruptedException{
        ...
        if(accountInformation.accountInformationText().isDisplayed() == true){
            ...
            //9.1) Verify Name and Email is already complete
            if(accountInformation.name() != null && accountInformation.email() != null){
        ...
        accountInformation.newsLetter().click();

        //11) Select checkbox 'Receive special offers from our partners!'
        accountInformation.specialOffers().click();
        ...
        accountInformation.createAccount().click();

        //14) Verify that 'ACCOUNT CREATED!' is visible
        if(accountCreated.accountCreated().isDisplayed() == true){

            //15) Click 'Continue' button
            accountCreated.continueButton().click();
        } else {
            driver.quit();
        }
        ...
        if(loggedInPage.loggedInAsUser().isDisplayed() == true){
            ...
            loggedInPage.deleteAccount().click();
        } else {
            driver.quit();
        }
